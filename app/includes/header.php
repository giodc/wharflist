...
<head>
    ...
    <style>
        ...
        .bg-blue-50, .bg-blue-100, .bg-blue-600, .bg-blue-700, .bg-blue-800 {
            background-color: #f3f4f6 !important; /* light gray for light blue */
        }
        .bg-blue-600, .bg-blue-700, .bg-blue-800 {
            background-color: #111827 !important; /* black for dark blue */
        }
        ...
        .hover\:text-blue-800:hover, .hover\:text-blue-700:hover {
        ...
        .border-blue-200, .border-blue-300 {
            border-color: #d1d5db !important; /* gray */
        }
        ...
        .focus\:ring-blue-500:focus, .focus\:ring-green-500:focus {
            --tw-ring-color: #6b7280 !important; /* gray */
        }
...
<body class="bg-gray-50 min-h-screen" x-data="{ mobileMenuOpen: false }" :class="{ 'menu-open': mobileMenuOpen }" @keydown.escape.window="mobileMenuOpen = false">
    <!-- Header -->
    <header class="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div class="px-4 lg:px-6 py-4 flex items-center justify-between">
            ...
            <div class="relative" x-data="{ open: false }">
                <button @click="open = !open" class="flex items-center space-x-2 px-4 py-2 rounded-lg hover:bg-gray-100 transition">
                    <span class="text-sm font-medium text-gray-700"><?= htmlspecialchars($user['username'] ?? 'User') ?></span>
